...
library("StatDA")
###########################################################
jpeg(filename="As-Cd-Cr.jpeg", width=35,height=40, res= 300, units = "cm") #Inicio Archivo con nombre y res ->resolucion
par(mfrow=c(3,2)) #graficar c(n°filas,n°columnas)

edaplot(data$As,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="As [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$As,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="clr(As)",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)

edaplot(data$Cd,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Cd [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Cd,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
           P.main="",P.xlab="clr(Cd)",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)

edaplot(data$Cr,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Cr [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Cr,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
...
edaplot(data$Cu,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Cu [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Cu,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
           P.main="",P.xlab="clr(Cu)",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)

edaplot(data$Hg,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Hg [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Hg,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
           P.main="",P.xlab="clr(Hg)",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)

edaplot(data$Pb,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Pb [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Pb,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
...
edaplot(data$Se,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Se [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Se,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
           P.main="",P.xlab="clr(Se)",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)

edaplot(data$Zn,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
        P.main="",P.xlab="Zn [mg/kg]",P.ylab="Relative frequency",B.pch=3,B.cex=0.5)
edaplotlog(matrix_clr$Zn,H.freq=FALSE,box=TRUE,H.breaks=30,S.pch=3,S.cex=0.5,D.lwd=1.5,P.log=FALSE,
